...
const TRANSLATIONS = {
  zh: {
    ...
    abt_tech_title: '技術架構',
    abt_tech_frontend: '純 HTML / CSS / JS，無框架',
    abt_tech_backend: 'Cloudflare Pages Functions',
    abt_tech_db: 'Cloudflare D1（SQLite）',
    abt_tech_deploy: 'Cloudflare Pages + GitHub 自動部署',
    abt_tech_auth: 'Cloudflare Access（Google 帳號）',
  },
  ...
  en: {
    ...
    abt_tech_frontend: 'Plain HTML / CSS / JS, no framework',
    abt_tech_backend: 'Cloudflare Pages Functions',
    abt_tech_db: 'Cloudflare D1 (SQLite)',
    abt_tech_deploy: 'Cloudflare Pages + GitHub auto-deploy',
    abt_tech_auth: 'Cloudflare Access (Google login)',
  }
};
